        ...
        public bool AjouterCourse(Courses UnCourse)
        {
            ...
            try
            {
                ...
                if (Connex.OuvrirConnexion())
                {
                    ...
                    string requete = "INSERT INTO `course` (`IdCourse`, `Nom`, `Date`, `Distance`, `HeureDepart`, `EnCours`) " +
                        "VALUES ('" + UnCourse.Nom + "', '" + datprevue + "', '" + UnCourse.Distance + "', '" + datprevue + "', '" + UnCourse.EnCours + "')";
            ...
            try
            {
                ...
                if (Connex.OuvrirConnexion())
                {
                    ...
                    string requete = "UPDATE course SET `Nom`= '" + UnCourse.Nom + "', `Date`= '" +
                        ...
                        datheure + "', `HeureDepart`= '" +UnCourse.EnCours + "' WHERE IdCourse = " + IdCourse + "";
